...
export const TruckFast = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <path
      d="M2.07 4.98H1.92H0.94C0.56 4.98 0.25 5.29 0.25 5.67C0.25 6.05 0.56 6.35 0.94 6.35H1.85H2V5.69C2 5.45 2.03 5.21 2.07 4.98Z"
      fill="currentColor"
    />
    <path
      d="M1.85 7.73H0.94C0.56 7.73 0.25 8.04 0.25 8.42C0.25 8.8 0.56 9.1 0.94 9.1H1.85H2V7.73H1.85Z"
      fill="currentColor"
    />
    <path
